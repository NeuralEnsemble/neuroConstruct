...
public class NetworkMLReaderTest 
{
    ...
    public void testSavingNeuroML2() throws InterruptedException, NeuroMLException
    {
        ...
        assertTrue("Validating: "+nml2bFile.getAbsolutePath(), NeuroMLFileManager.validateAgainstLatestNeuroML2Schema(nml2bFile));
    }
    ...
    public void testSavingLoadingNetworkNML2() throws InterruptedException, NeuroMLException, Hdf5Exception, EndOfSequenceException, NoProjectLoadedException
    {
        ...
        assertTrue(NeuroMLFileManager.validateAgainstLatestNeuroML2Schema(nmlFile));
