...
extern int nrn_get_mechtype();
 ...
 "setdata_Gran_KDr_98", _hoc_setdata,
 "rates_Gran_KDr_98", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Gran_KDr_98
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Gran_KDr_98", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Gran_KDr_98", "S/cm2",
 "gion_Gran_KDr_98", "S/cm2",
 "mtau_Gran_KDr_98", "ms",
 "htau_Gran_KDr_98", "ms",
 0,0
};
 ...
 "usetable_Gran_KDr_98", &usetable_Gran_KDr_98,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Gran_KDr_98 /home/padraig/neuroConstruct/testProjects/TestHDF5/generatedNEURON/x86_64/Gran_KDr_98.mod\n");
...
static int _reset;
static char *modelname = "Channel: Gran_KDr_98";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_m = pow( 3.0 , ( ( celsius - 17.350264793 ) / 10.0 ) ) ;
   ...
   _lv = _lv - ( 10.0 ) ;
   _lv = _lv * 0.001 ;
   _lalpha = 170.0 * ( ( exp ( 73.0 * ( _lv - ( - 0.038 ) ) ) ) ) ;
   _lalpha = _lalpha * 0.001 ;
   _lv = _lv * 1000.0 ;
   _lv = _lv * 0.001 ;
   _lbeta = 170.0 * ( ( exp ( ( - 18.0 ) * ( _lv - ( - 0.038 ) ) ) ) ) ;
   _lbeta = _lbeta * 0.001 ;
   _lv = _lv * 1000.0 ;
   ...
   if ( _lv > - 0.046 ) {
     ...
     _lalpha = 0.7 + 0.065 * ( exp ( - 80.0 * ( _lv - ( - 0.046 ) ) ) ) ;
     }
   _lalpha = _lalpha * 0.001 ;
   _lv = _lv * 1000.0 ;
   _lv = _lv * 0.001 ;
   _lbeta = 1.1 / ( 1.0 + ( exp ( - 80.7 * ( _lv - ( - 0.044 ) ) ) ) ) ;
   _lbeta = _lbeta * 0.001 ;
   _lv = _lv * 1000.0 ;
