...
extern int nrn_get_mechtype();
 ...
 "setdata_Gran_H_98", _hoc_setdata,
 "rates_Gran_H_98", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Gran_H_98
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Gran_H_98", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Gran_H_98", "S/cm2",
 "gion_Gran_H_98", "S/cm2",
 "ntau_Gran_H_98", "ms",
 0,0
};
 ...
 "usetable_Gran_H_98", &usetable_Gran_H_98,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Gran_H_98 /home/padraig/neuroConstruct/testProjects/TestHDF5/generatedNEURON/x86_64/Gran_H_98.mod\n");
...
static int _reset;
static char *modelname = "Channel: Gran_H_98";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_n = pow( 3.0 , ( ( celsius - 17.350264793 ) / 10.0 ) ) ;
   _lv = _lv - ( 10.0 ) ;
   _lA_alpha_n = 0.8 ;
   _lB_alpha_n = - 0.01100110011 ;
   _lVhalf_alpha_n = - 0.075 ;
   _lA_alpha_n = _lA_alpha_n * 0.001 ;
   _lB_alpha_n = _lB_alpha_n * 1000.0 ;
   _lVhalf_alpha_n = _lVhalf_alpha_n * 1000.0 ;
   _lalpha = _lA_alpha_n * exp ( ( _lv - _lVhalf_alpha_n ) / _lB_alpha_n ) ;
   _lA_beta_n = 0.8 ;
   _lB_beta_n = 0.01100110011 ;
   _lVhalf_beta_n = - 0.075 ;
   _lA_beta_n = _lA_beta_n * 0.001 ;
   _lB_beta_n = _lB_beta_n * 1000.0 ;
   _lVhalf_beta_n = _lVhalf_beta_n * 1000.0 ;
