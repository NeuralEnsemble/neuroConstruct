	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA /home/padraig/neuroConstruct/testProjects/TestHDF5/generatedNEURON/x86_64/NMDA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: NMDA";
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   gblock = 1.0 / ( 1.0 + ( mg_conc * eta * exp ( - 1.0 * gamma * v ) ) ) ;
   g = gmax * gblock * ( B - A ) ;
   i = g * ( v - e ) ;
   }
 _current += i;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 126 in file NMDA.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
