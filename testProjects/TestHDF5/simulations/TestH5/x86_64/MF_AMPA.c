	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 MF_AMPA /home/padraig/neuroConstruct/testProjects/TestHDF5/generatedNEURON/x86_64/MF_AMPA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: MF_AMPA";
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 113 in file MF_AMPA.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
