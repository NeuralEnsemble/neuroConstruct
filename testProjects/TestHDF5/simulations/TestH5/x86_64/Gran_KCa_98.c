...
extern int nrn_get_mechtype();
 ...
 "setdata_Gran_KCa_98", _hoc_setdata,
 "settables_Gran_KCa_98", _hoc_settables,
 0, 0
};
 ...
 "gmax_Gran_KCa_98", "S/cm2",
 "gion_Gran_KCa_98", "S/cm2",
 "mtau_Gran_KCa_98", "ms",
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 Gran_KCa_98 /home/padraig/neuroConstruct/testProjects/TestHDF5/generatedNEURON/x86_64/Gran_KCa_98.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: Gran_KCa_98";
...
static int  settables ( _p, _ppvar, _thread, _nt, _lv , _lcai ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lcai ;
 {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _lca_conc , _ltemp_adj_m , _lA_alpha_m , _lB_alpha_m , _lVhalf_alpha_m , _lA_beta_m , _lB_beta_m , _lVhalf_beta_m ;
  _ltemp_adj_m = pow( 3.0 , ( ( celsius - 17.350264793 ) / 10.0 ) ) ;
   _lv = _lv - ( 10.0 ) ;
   _lca_conc = _lcai ;
   _lv = _lv * 0.001 ;
   _lalpha = 2500.0 / ( 1.0 + ( ( 1.5e-3 * ( exp ( - 85.0 * _lv ) ) ) / _lca_conc ) ) ;
   _lalpha = _lalpha * 0.001 ;
   _lv = _lv * 1000.0 ;
   _lv = _lv * 0.001 ;
   _lbeta = 1500.0 / ( 1.0 + ( _lca_conc / ( 1.5e-4 * ( exp ( - 77.0 * _lv ) ) ) ) ) ;
   _lbeta = _lbeta * 0.001 ;
   _lv = _lv * 1000.0 ;
