...
extern int nrn_get_mechtype();
 ...
 "setdata_Gran_KA_98", _hoc_setdata,
 "rates_Gran_KA_98", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Gran_KA_98
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Gran_KA_98", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Gran_KA_98", "S/cm2",
 "gion_Gran_KA_98", "S/cm2",
 "mtau_Gran_KA_98", "ms",
 "htau_Gran_KA_98", "ms",
 0,0
};
 ...
 "usetable_Gran_KA_98", &usetable_Gran_KA_98,
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 Gran_KA_98 /home/padraig/neuroConstruct/testProjects/TestHDF5/generatedNEURON/x86_64/Gran_KA_98.mod\n");
...
static int _reset;
static char *modelname = "Channel: Gran_KA_98";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_m , _lA_tau_m , _lB_tau_m , _lVhalf_tau_m , _lA_inf_m , _lB_inf_m , _lVhalf_inf_m , _ltemp_adj_h , _lA_tau_h , _lB_tau_h , _lVhalf_tau_h , _lA_inf_h , _lB_inf_h , _lVhalf_inf_h ;
  _ltemp_adj_m = pow( 1.0 , ( ( celsius - 17.350264793 ) / 10.0 ) ) ;
   _ltemp_adj_h = pow( 1.0 , ( ( celsius - 17.350264793 ) / 10.0 ) ) ;
   _lv = _lv - ( 10.0 ) ;
   _ltau = 0.410 * ( ( exp ( ( ( ( _lv ) + 43.5 ) / ( - 42.8 ) ) ) ) ) + 0.167 ;
   ...
   minf = _linf ;
   _ltau = 10.8 + ( 0.03 * _lv ) + ( 1.0 / ( 57.9 * ( exp ( _lv * 0.127 ) ) + ( 134e-6 * ( exp ( _lv * - 0.059 ) ) ) ) ) ;
