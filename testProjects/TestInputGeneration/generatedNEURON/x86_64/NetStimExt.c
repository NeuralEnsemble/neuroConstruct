...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimExt /home/matteo/neuroConstruct/testProjects/TestInputGeneration/generatedNEURON/x86_64/NetStimExt.mod\n");
