	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 DoubExpSyn /home/matteo/neuroConstruct/testProjects/TestInputGeneration/generatedNEURON/x86_64/DoubExpSyn.mod\n");
 ...
 v=_v;
{
 ...
 error =  state();
 if(error){fprintf(stderr,"at line 114 in file DoubExpSyn.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
