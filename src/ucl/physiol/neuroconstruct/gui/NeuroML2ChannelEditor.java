...
/**
 * Dialog for creating and editing NeuroML2/LEMS based Cell Mechanism
...
public class NeuroML2ChannelEditor extends JFrame implements HyperlinkListener
{
    private static ClassLogger logger = new ClassLogger("NeuroML2ChannelEditor");

    Project project = null;

    XMLCellMechanism xmlMechanism = null;

    private final static String CHANNELML = "NeuroML2 channel";
    ...
    private String CML_CONTENTS_TAB = "NeuroML2 file";
    ...
    JButton jButtonReload = new JButton("Reload NeuroML2 file");
    JButton jButtonPlot = new JButton("Generate associated plots");
    JButton jButtonEditExt = new JButton("Edit NeuroML2 file externally");
    ...
    public NeuroML2ChannelEditor(XMLCellMechanism cmlMechanism, Project project, ProjectEventListener eventIf)
    {
        super();
        ...
        if (xmlMechanism instanceof NeuroML2Component)
        {   System.out.println("XML mechanism is of NeuroML2 format");
            xmlDialect = CHANNELML;
        }   
        else if (xmlMechanism instanceof ChannelMLCellMechanism)
        {
            System.out.println("XML mechanism is of ChannelML format");
        }
        else if (xmlMechanism instanceof SBMLCellMechanism)
        { xmlDialect = SBML;}
        else
        {
            System.out.println("format of XML mechanism is not defined");
        }
        ...
        catch (Exception ex)
        {
            ...
            System.out.println("NeuroML2 mechanism display was not built in neuroConstruct");
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            NeuroML2ChannelEditor.logger.setThisClassVerbose(false);
