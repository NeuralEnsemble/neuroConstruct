...
public class ProjectStructure
{
    ...
    private static String neuroML1Dir = "generatedNeuroML";

    private static String neuroML2Dir = "generatedNeuroML2";
    ...
    private static String jnmlDir = "jNeuroMLJar";
    ...
    public static File getjNeuroMLDir()
    {
        return new File(getnCHome(), jnmlDir);
    }
...
/*
    ...
    public static File getNeuroML1Dir(File projectDir)
    {
        return getDirectoryInProject(projectDir, neuroML1Dir,
                                    "This is the directory for the NeuroML files generated by neuroConstruct for this project.\n");
    }

    public static File getNeuroML2Dir(File projectDir)
    {
        return getDirectoryInProject(projectDir, neuroML2Dir,
                                    "This is the directory for the NeuroML 2/LEMS files generated by neuroConstruct for this project.\n");
    }
    
    public static File getNeuroMLDir(File projectDir, NeuroMLConstants.NeuroMLVersion version)
    {
        File neuroMLDir = version.isVersion2() ? ProjectStructure.getNeuroML2Dir(projectDir)
                : ProjectStructure.getNeuroML1Dir(projectDir);
        return neuroMLDir;
    }
